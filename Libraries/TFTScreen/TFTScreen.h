...
class TFTScreen : public Adafruit_GFX 
{
	public:
		...
		virtual void drawPixel(int16_t x, byte y, uint16_t color);  // and these three
		...
		virtual void     fillRect(int16_t x, byte y, int16_t w, byte h, uint16_t color);
		virtual void     drawFastVLine(int16_t x, byte y, int16_t h, uint16_t color) { fillRect(x, y, 1, h, color); }
		virtual void     drawFastHLine(int16_t x, byte y, int16_t w, uint16_t color) { fillRect(x, y, w, 1, color); }
